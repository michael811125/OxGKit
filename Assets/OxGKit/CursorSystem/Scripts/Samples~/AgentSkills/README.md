...
- API signatures were verified against OxGKit.CursorSystem v1.0.0. Newer versions may differ — the skill instructs the agent to re-verify against the installed package source.

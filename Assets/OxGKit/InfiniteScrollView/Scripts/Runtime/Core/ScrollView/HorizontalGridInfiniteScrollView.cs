                    ...
                    for (int i = 0; i < this._dataList.Count; i += this.rowCount)
                    {
                        for (int j = 0; j < this.rowCount; j++)
                        {
                                ...
                                visibleRange.x <= viewportRange.y)
                            {
                                ...
                                this.visibleCount++;
                                if (this.visibleCount % this.rowCount == 0)
                                ...
                                float dirCoeff = 1f;
                                if (cell != null)
                                    dirCoeff = cell.rectTransform.pivot.x > 0 ? -1f : 1f;
                                ...
                                if (this._cellList[index] == null)
                                {
                                    ...
                                    if (this._cellPool.Count > 0)
                                        cell = this._cellPool.Dequeue();
                                            ...
                                            PrintError<Logger>("The cell display error occurred, not enough cells in the cell pool!!!");
                                }

...
- API signatures were verified against OxGKit.InfiniteScrollView v1.7.1. Newer versions may differ — the skill instructs the agent to re-verify against the installed package source.

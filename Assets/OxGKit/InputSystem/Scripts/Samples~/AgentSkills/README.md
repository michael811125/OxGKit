...
- API signatures were verified against OxGKit.InputSystem v1.0.4. Newer versions may differ — the skill instructs the agent to re-verify against the installed package source.

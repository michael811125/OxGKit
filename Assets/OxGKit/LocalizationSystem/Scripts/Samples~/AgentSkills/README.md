...
- API signatures were verified against OxGKit.LocalizationSystem v1.0.1. Newer versions may differ — the skill instructs the agent to re-verify against the installed package source.

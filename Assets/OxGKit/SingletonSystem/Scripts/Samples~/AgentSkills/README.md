...
- API signatures were verified against OxGKit.SingletonSystem v1.0.2. Newer versions may differ — the skill instructs the agent to re-verify against the installed package source.

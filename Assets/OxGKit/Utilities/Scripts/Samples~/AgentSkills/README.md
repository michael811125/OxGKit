...
- API signatures were verified against OxGKit.Utilities v1.4.7. Newer versions may differ — the skill instructs the agent to re-verify against the installed package source.
